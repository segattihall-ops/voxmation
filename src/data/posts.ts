...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "what-is-voice-prompt-automation",
    title: "What Is Voice Prompt Automation? A Complete Guide for 2025",
    description:
...
Voice prompt automation isn't set-and-forget, but once your call flows are dialed in, they run 24/7 at a fraction of the cost of live agents.
  ...
  {
    slug: "asterisk-vs-twilio-outbound-campaigns",
    title: "Asterisk vs Twilio for Outbound Voice Campaigns: Which Should You Choose?",
    description:
...
This means you're not locked into either choice. Start with Twilio, validate your campaign economics, then migrate the high-volume flows to Asterisk when the cost savings justify the operational investment.
  ...
  {
    slug: "how-to-build-an-ivr-menu",
    title: "How to Build an IVR Menu in 2025 (Asterisk, FreeSWITCH, and Twilio)",
    description:
