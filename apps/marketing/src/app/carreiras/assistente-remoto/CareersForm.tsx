...
import {
  ...
  type LogicQuestion
} from "@/data/vagaAssistente";

const MAX_RESUME_BYTES = 3 * 1024 * 1024; // 3MB (stays under the serverless body limit)
...
export default function CareersForm() {
  ...
  function onResumeChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (file.size > MAX_RESUME_BYTES) {
      setError("O currículo deve ter no máximo 3MB.");
      return;
    }
    setError(null);
    setResumeFile(file);
          ...
          <section id="candidatar" className="px-4 sm:px-6 lg:px-8 py-10 scroll-mt-20">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-500 mb-8">
                Leva uns 10 minutos. Você receberá um e-mail confirmando o recebimento.
              </p>
              ...
              <div className="bg-gray-900/40 border border-gray-800/60 rounded-2xl p-6 sm:p-8">
                ...
                {step === 1 && (
                  <div>
                    <Field label="Currículo (PDF ou Word, até 3MB)">
                      <label
                        className={clsx(
                  ...
                  <div className="space-y-6">
                    ...
                    <label className="flex items-start gap-3 p-4 rounded-lg bg-gray-900/40 border border-gray-800 cursor-pointer">
                      ...
                      <span className="text-sm text-gray-400 leading-relaxed">
                        ...
                        LGPD. Entendo que receberei um e-mail confirmando o recebimento da minha
                        candidatura.
                      </span>
                    </label>
                  </div>
    ...
    <section className="px-4 sm:px-6 lg:px-8 py-20">
      <div className="max-w-xl mx-auto text-center">
        ...
        <p className="text-gray-400 leading-relaxed mb-8">
          Vamos analisar sua inscrição e, se fizer sentido, entramos em contato por este mesmo
          e-mail. Confira também a caixa de spam. Não precisa fazer mais nada. 🙌
        </p>
      </div>
    </section>
  );
